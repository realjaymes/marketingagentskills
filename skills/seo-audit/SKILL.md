...
- [Comprehensive SEO Reference](references/seo-comprehensive-reference.md): Deep technical reference covering SEO foundations, strategy, technical SEO, on-page and content SEO, off-page SEO, analytics, algorithm updates, GEO/AEO, engagement playbooks, scenario playbooks, cross-functional collaboration, and the full tool stack. Load specific sections on demand when an audit question requires more depth than SKILL.md's overview (e.g., crawl budget diagnosis on a large site, traffic-drop diagnosis after an algorithm update, migration scoping, keyword clustering methodology, log file analysis).
...
This skill is an enhanced fork of [`coreyhaines31/marketingskills/seo-audit`](https://github.com/coreyhaines31/marketingskills/tree/main/skills/seo-audit) (synced through v1.2.0). The base SKILL.md, `references/ai-writing-detection.md`, `references/international-seo.md`, and the International SEO & Localization section originate from Corey Haines's repo. The `references/seo-comprehensive-reference.md` reference and the title-tag guidance noting that SERPs append brand names automatically are original work added in this fork.
